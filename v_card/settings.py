"""
Django settings for v_card project.
...
SECRET_KEY = 'django-insecure-65apoyw+^fxu=9&shkmc)4fq9=raq*g88i&lv#vxoj9-$g^i8s'
...
WSGI_APPLICATION = 'v_card.wsgi.application'
